                                                                                ...
                                                                                @foreach ($products as $key => $product)
                                                                                    <tr>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    @if ($product->image)
                                                                                                        <img src="{{ asset('uploads/products/' . $product->image) }}"
                                                                                                            style="width: 100%; height: 100%; object-fit: contain;" class="mb-2">
                                                                                                    @endif
                                                                                                </div>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <a href="javascript:void(0);" class="btn btn-danger btn-sm delete-product" data-id="{{ $product->id }}">Delete <i
                                                            ...
                                                            <form action="{{ url('admin/update-product/' . $product->id) }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="name" value="{{ old('product_id') == $product->id ? old('name') : $product->name }}"
                                                                            class="form-control">
                                                                        @if(old('product_id') == $product->id)
                                                                            @error('name')
                                                                                <small class="text-danger">{{ $message }}</small>
                                                                    ...
                                                                    <select name="category_id" id="category_id_{{ $product->id }}" class="form-control category-dropdown"
        ...
        <script>
            ...
            $(document).on('click','.delete-product', function(e){
                ...
                Swal.fire({
                    ...
                    title:'Are you sure?',
                    text:"This product will be deleted parmanently!",
                    icon:'warning',
